...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        this.addMouseListener(new bsu.rfe.java.teacher.GraphicsDisplay.MouseHandler(this));
        this.addMouseMotionListener(new bsu.rfe.java.teacher.GraphicsDisplay.MouseMotionHandler(this));
    }
